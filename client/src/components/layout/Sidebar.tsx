  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 bg-white border-r border-gray-200 p-4">
      ...
      <nav className="space-y-1 flex-1">
        ...
        <Link href="/find-buddies" className={`flex items-center space-x-3 px-3 py-2 rounded-lg ${
        ...
        <Link href="/messages" className={`flex items-center space-x-3 px-3 py-2 rounded-lg ${
            isActive("/messages") 
              ? "bg-primary-50 text-primary-700" 
              : "text-gray-700 hover:bg-gray-100"
          }`}>
        ...
        <Link href="/profile" className={`flex items-center space-x-3 px-3 py-2 rounded-lg ${
            isActive("/profile") 
              ? "bg-primary-50 text-primary-700" 
              : "text-gray-700 hover:bg-gray-100"
          }`}>
        ...
        <div className="pt-4 border-t border-gray-200">
          <div className="flex items-center px-3 py-2">
            ...
            <div className="ml-3">
              ...
              <Link href="/profile" className="text-xs text-gray-500">View Profile</Link>
            </div>
          </div>
        </div>
      ) : (
        <div className="pt-4 border-t border-gray-200">
          <Link href="/login" className="block w-full bg-primary text-white py-2 rounded-lg text-sm font-medium text-center">
            Sign In
          </Link>
          <Link href="/register" className="block w-full mt-2 text-primary py-2 rounded-lg text-sm font-medium text-center">
            Create Account
          </Link>
        </div>
      )}
